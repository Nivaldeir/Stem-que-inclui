      ...
      <Header />
       ...
       <main className="bg-background pt-20">
          ...
          <div className="">
            <div className="text-center">
              ...
              <p className="text-lg text-muted-foreground">
                Visualização interativa do nosso impacto global
              </p>
            </div>

          </div>

          <div className="grid z-[500] grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div className="space-y-4">
              <h2 className="text-2xl font-semibold text-foreground">
                Nosso Impacto
              </h2>
              <p className="text-muted-foreground z-[500]">
                Esta visualização 3D mostra os pontos onde nossa ONG tem presença
                e impacto ao redor do mundo. Cada arco representa uma conexão entre
                comunidades que estamos ajudando.
              </p>
              <div className="flex flex-wrap gap-4">
                ...
                <div className="bg-primary/10 p-4 rounded-lg">
                  <h3 className="font-semibold text-primary">10K+</h3>
        ...
        <section id="about" className="container mx-auto px-4 py-8">
          ...
          <p className="text-sm md:text-base mt-4 text-white font-normal inter-var text-center max-w-3xl  mx-auto">
            Nossa missão é democratizar o acesso à tecnologia e educação digital,
            capacitando comunidades vulneráveis para o futuro. Através de programas
            de capacitação, mentoria e acesso a recursos tecnológicos, construímos
            pontes que conectam pessoas ao mundo digital, criando oportunidades
            reais de crescimento econômico e social.
          </p>
          <div>
            <div>
        ...
        <section id="contact" className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Quer fazer parte da nossa missão? Tem alguma dúvida ou sugestão?
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-10">
            ...
            <div className="space-y-8">
                ...
                <div className="space-y-6">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">contato@onginclusaodigital.org</p>
                      <p className="text-muted-foreground">parcerias@onginclusaodigital.org</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">
                        Rua da Inclusão Digital, 123<br />
              ...
              {/* Redes Sociais */}
              <div>
                <h3 className="text-xl font-semibold text-foreground mb-4 mb">
